...
import com.example.madraf.litterally.Model.Cart;
import com.example.madraf.litterally.Prevalent.Prevalent;
import com.example.madraf.litterally.ViewHolder.CartViewHolder;
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task)
                                                {
                                                    if (task.isSuccessful())
                                                    {
                                                        ...
                                                        Intent intent = new Intent(CartActivity.this, Recycle.class);
                                                        startActivity(intent);
                                                    }
                                                }
                                            });

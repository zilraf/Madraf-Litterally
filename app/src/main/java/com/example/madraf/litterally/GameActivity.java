...
public class GameActivity extends AppCompatActivity {
    ...
    public void changePos() {
        ...
        /*if (score==50){
            ...
            box.setScaleX(boxWidth);
            box.setScaleY(boxHeight);

            changeBoxSize(boxWidth,boxHeight);
        }*/
    ...
    public void changeBoxSize(int boxWidth,int boxHeight) {
    ...
    public void quitGame(View view) {
        Intent a = new Intent(GameActivity.this, MainMenu.class);
        startActivity(a);
        finish();
